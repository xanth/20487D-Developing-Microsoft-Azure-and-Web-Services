...
9. Change the end of the url in the opened browser window to **api/hotels** instead of **api/value** and then press **Enter**:
    >**NOTE:** Your url should look like this after this change :**localhost:{port}/api/hotels**.

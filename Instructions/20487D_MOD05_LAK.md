...
6. Open **File Explorer** and navigate to the **Assets** folder in **[Repository Root]\Allfiles\Mod05\Labfiles\Exercise1\Assets**.
...
1. Paste the following command in order to start your **Windows Service** and then press **Enter**:
   ...
   ```
2. Verify that the service is working by open a browser and navigate to **http://localhost:5000/api/flights**.
...
1. Open a browser and navigate to **http://portal.azure.com**. If you are prompted to sign in, sign in by using your Azure account credentials.
...
3. Open a browser and navigate to your **FTP hostname** address that you have copied from the previous exercise (in **Task 4** - **Point 8**).
...
10. Paste the following command in order to run the docker container which listening on a default port and then press **Enter**:
    ...
    ```
11. Open a browser and navigate to **localhost:8080/api/hotels**.
...
14. Paste the following command in order to push your container image into **Docker Hub** and then press **Enter**:
    ...
    ```
15. Open a browser and navigate to **https://hub.docker.com**. Then **Sign In** with your credentials.
...
11. Change directory in the command line by pasting the following command and then press **Enter**:
    ...
    ```
12. Paste the following command in order to test the newly **Azure Function** locally and then press **Enter**:
    ```bash
        func host start --build
    ```
13. Paste the following command in order to login to **Azure** with your credentials before publishing the newly **Azure Function** to **Azure** and then press **Enter**:
    ```bash
        func azure login
    ```

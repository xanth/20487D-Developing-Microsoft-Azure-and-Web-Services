...
### Exercise 1: Create a cache filter
...
2. Run the following command to change directory to the starter project:
    ...
    ```
3. Run following command to restore all dependencies and tools of a project:
    ```base
    dotnet restore
    ```
4. Run the following command to open the project in **VSCode**:
    ...
    code .
    ```
5. Right-click on **BlueYonderHotels.Service** folder and select **New Folder** then type **Attirbutes** to create new **Attirbutes**  folder.
6. Right-click on  **Attirbutes** folder and select **New Flie** then type **CacheAttribute.cs** to create new  **CacheAttribute** class.
...
8. Paste the following code to add **namespace**:
    ...
    ```
9. Paste the following code inside the **namespace** brackets to class declaration:
    ```cs
    ...
    ```
10. Paste the following code inside the **class** brackets to add fields to the class:
    ```cs
    ...
    ```
11. Paste the following code inside the **class** brackets to add contractor with **int** optionl parameter: 
    ```cs
    ...
    ```
12. Paste the following code inside the **class** brackets to add contractor with **string** parameter:
    ```cs
    ...
    ``` 
13. Paste the following code inside the **class** brackets to add method to check the cache validation:
    ```cs
    ...
    ```
14. Paste the following code inside the **class** brackets to override **OnActionExecuting** method:
    ```cs
    ...
    ```
15. Paste the following code inside the **class** brackets to override **OnResultExecuted** method:
    ```cs
...
### Exercise 2: Create a debugging middleware

...
10. Paste the following code inside the **class** brackets to add fields to the class:
    ...
    ```
11. Paste the following code inside the **class** brackets to add constructor with **int** optionl parameter: 
    ```cs
    ...
    ```
12. Paste the following code inside the **class** brackets to add constructor with **string** parameter:
    ```cs

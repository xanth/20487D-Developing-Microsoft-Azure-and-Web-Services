...
2. To the **Startup.cs** class, add the following **using** statement:
    ...
    ```
2. To register the repository, in **Startup.cs**, locate the **ConfigureServices** method, and then add the following code:
    ```cs
...
3. In **Developer Tools**, click the **Network** tab, and then select **Reservation**.

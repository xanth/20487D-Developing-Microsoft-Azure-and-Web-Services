...
2. Add the following **using**:
    ...
    ```
3. Locate class declaration and replace it with the following code to use **IHotelBookingRepository** interface.
    ```cs
...
2. Replace **HotelBookingRepository** field to **IHotelBookingRepository** like the following code:
    ```cs
    private readonly IHotelBookingRepository _hotelBookingRepository;
    ```
3. Locate class constructor and replace it with the following code to get **IHotelBookingRepository** interface as paramter.
    ```cs

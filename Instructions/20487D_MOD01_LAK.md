...
8. To run the scripts in the database, click **Mod1DB**, then click **Query editor**.
9. Click **Login** and then enter the following password **Password99**.
...
3. Click **Mod1DB**, and then click **Query editor**.

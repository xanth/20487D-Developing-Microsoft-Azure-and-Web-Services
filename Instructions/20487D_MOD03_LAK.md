...
2. At the **Command Line** paste the following command to change directory to **Starter** project:
    ```bash
    cd [Repository Root]\Allfiles\Mod03\LabFiles\Lab3\Starter
    ```
3. Run the following command to change directory to the starter project:
    ```bash
    dotnet restore
    ```
...
2. Run the following command to change directory to **BlueYonder.Hotels.Service** project:
    ```bash
    cd [Repository Root]\Allfiles\Mod03\LabFiles\Lab3\Starter\BlueYonder.Hotels.Service
    ```
...
5. Change directory to the Client project, by running the following command in the **Command Line**:
   ```bash
    cd [Repository Root]\Allfiles\Mod03\LabFiles\Lab3\Starter\BlueYonder.Hotels.Client
   ```

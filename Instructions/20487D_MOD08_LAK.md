...
2. Click **All resources**, and then click **blueyondermod08lab2***{YourInitials}* type of **Application Insights**.
...
5. To view the **Performance** of the test, click the **Charts** tab.

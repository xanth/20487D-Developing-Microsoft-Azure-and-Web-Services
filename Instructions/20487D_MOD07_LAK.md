...
7. Click **Review + Create**, and then wait for the resource to be created.
...
3. In [Repository Root]**\Allfiles\Mod07\LabFiles\Lab2\Assets**, click **folder**, select the **GraphData.json** file, and then click **Upload**.

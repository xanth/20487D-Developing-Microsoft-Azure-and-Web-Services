...
1. Right click on **Models** folder, select **New File**, then type **Traveler.cs** in the textbox on the top, and press **Enter**.
2. In the **Traveler.cs** paste the following code:
    ```cs
...
3. Right click on **Models** folder, select **New File**, then type **Room.cs** in the textbox on the top, and press **Enter**.
4. In the **Room.cs** paste the following code:
    ```cs
    ...
    ```
5. Right click on **Models** folder, select **New File**, then type **Hotel.cs** in the textbox on the top, and press **Enter**.
6. In the **Hotel.cs** paste the following code:
    ```cs
    using System.Collections.Generic;
    ...
    ```    
7. Right click on **Models** folder, select **New File**, then type **Booking.cs** in the textbox on the top, and press **Enter**.
8. In the **Booking.cs** paste the following code:
    ```cs
    using System;
